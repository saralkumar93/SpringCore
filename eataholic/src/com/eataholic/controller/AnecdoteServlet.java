...
/**
 * Servlet implementation class AnecdoteServlet
 */
@WebServlet("/AnecdoteServlet")
public class AnecdoteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AnecdoteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/jsp/anecdote.jsp").forward(request, response);
	}
