...
<div class='wrapper_ye'>
  <header>
   ...
   <div class="product-menu-header"><h2>美食食谱</h2></div>
	...
	<div class="page">
	      <a href = "recipe?curPage=1" >首页</a>  
<a href = "recipe?curPage=<%=curPage>1?curPage-1:curPage%>" >上一页</a>  
<a href = "recipe?curPage=<%=curPage<pageCount?curPage+1:pageCount%>" >下一页</a>  
<a href = "recipe?curPage=<%=pageCount%>" >尾页</a>  
