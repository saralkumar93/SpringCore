...
<div class='wrapper_ye'>
  <header>
   ...
   <div class="product-menu-header"><h2>美食趣事</h2></div>
	...
	<div class="page">
	      <a href = "anecdote?curPage=1" >首页</a>  
<a href = "anecdote?curPage=<%=curPage>1?curPage-1:curPage%>" >上一页</a>  
<a href = "anecdote?curPage=<%=curPage<pageCount?curPage+1:pageCount%>" >下一页</a>  
<a href = "anecdote?curPage=<%=pageCount%>" >尾页</a>  
